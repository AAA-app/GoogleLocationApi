package com.aaa.googlelocationapi;
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                switch (statusCode) {
                    ...
                    case  LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                        String message = "Adjust location settings jin your device";
            ...
            if (grantResults.length <= 0) {
                ...
                showSnackBar("Turn on location on settings", "Settings", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Uri uri = Uri.fromParts("package", com.aaa.googlelocationapi.BuildConfig.APPLICATION_ID, null);
                        intent.setData(uri);
